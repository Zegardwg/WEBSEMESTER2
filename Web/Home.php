...
// Periksa apakah parameter keyword ada dalam URL
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
             ...
             <div class="main">
              <a href="profiluser.php" class="logo">
                  <image src="http://localhost/user/foto/<?php echo htmlspecialchars($user['foto']); ?>">
              </a>
          </div>
              <div class="auth-links">
                <a href="logout.php" class="Daftar">Logout</a>
          </div>
                <style>
        .navbar {
